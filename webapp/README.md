...
(`morphbpe-penalty8`, the Phase‑3‑selected artifact) behind a browser UI,
...
just tokenized on the Tokenizer tab and compares MorphBPE penalty-8, Plain
...
│       │   └── tokenizer.py
│       ├── artifacts/
│       │   ├── morphbpe-penalty8/          <- UNCHANGED copy of the 9 artifact files
...
[startup] tokenizer artifact loaded: morphbpe-penalty8 (vocab size 6080)
...
- **Your Input — 3-Way Split** — the exact text you just tokenized, run
  through MorphBPE penalty-8, Plain BPE, and Unigram-LM live.
